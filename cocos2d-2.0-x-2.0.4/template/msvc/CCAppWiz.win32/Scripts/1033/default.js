...
function AddConfigurations(proj, strProjectName) {
    try {
        ...
        for (nCntr = 0; nCntr < nNumConfigs; nCntr++) {
            ...
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx';
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx\\include';
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx\\kazmath\\include';
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx\\platform\\win32';
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx\\platform\\third_party\\win32';
            strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\cocos2dx\\platform\\third_party\\win32\\OGLES';
            
            if (wizard.FindSymbol('CC_USE_BOX2D')) {
                strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\external';
            }
            if (wizard.FindSymbol('CC_USE_CHIPMUNK')) {
                strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\external\\chipmunk\\include\\chipmunk';
            }
            if (wizard.FindSymbol('CC_USE_COCOS_DENSHION_SIMPLE_AUDIO_ENGINE')) {
                strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\CocosDenshion\\include';
            }
            if (wizard.FindSymbol('CC_USE_LUA')) {
                strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\scripting\\lua\\cocos2dx_support';
                strAddIncludeDir += 'D:\\studying\\cocos2d-2.0-x-2.0.4\\scripting\\lua\\tolua';
                strAddIncludeDir += ';D:\\studying\\cocos2d-2.0-x-2.0.4\\scripting\\lua\\lua';
            }
...
function GetTargetName(strName, strProjectName) {
    try {
        ...
        var strTemp = "D:\\studying\\cocos2d-2.0-x-2.0.4\\scripting\\lua";
